...
/*   Updated: 2023/05/23 00:21:03 by lucas            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int Fixed::toInt(void) const { return this->_raw / (1 << this->_bits); }

float Fixed::toFloat(void) const { return this->_raw / (float)(1 << this->_bits); }
